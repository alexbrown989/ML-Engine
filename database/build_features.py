...
def calculate_features(df):
    ...
    # --- Regime (preserve raw and one-hot for flexibility) ---
    ...
    df['regime_raw'] = df['regime']  # Preserve original

    # --- Coerce numeric inputs ---
    for col in ['vix', 'vvix', 'skew', 'rsi']:
        df[col] = pd.to_numeric(df.get(col, np.nan), errors='coerce')

    # --- Technical Indicators & Engineering ---
    ...
    # --- One-hot encode regimes but preserve raw for model ---
